def config_JointEmbeddingModel():
    config = {
        'data_params':{
            ...
            #valid data
            # 'valid_methname': 'valid.name.h5',
            # 'valid_apiseq': 'valid.apiseq.h5',
            ...
            #parameters
            'methname_len': 8,  # 8,  # default 6
            # 'apiseq_len': 30,  # 30,  # default 30
            'tokens_len': 250,  # 250,  # default 50
            'desc_len': 50,  # 50,   # default 30
            'n_words': 10000,  # len(vocabulary) + 1 10000
            #vocabulary info
        ...
        'training_params': {           
            ...
            'save_every': 10,
            'reload': -1,   #default -1 , #epoch that the model is reloaded from . If reload=0, then train from scratch
        },

        'model_params': {
            'n_embed_dims': 100,
            'n_hidden': 400,  # default 400, #number of hidden dimension of code/desc representation
            # recurrent
            'n_lstm_dims': 200,  # default 200  # * 2
