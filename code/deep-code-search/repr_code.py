...
def repr_code(args):
    ...
    if args.reload_from > 0:
        ...
        # ckpt_path = f'/home/huangxin/code/model/dcs/step{args.reload_from}.h5'
    ...
    use_set = eval(config['dataset_name'])(data_path,
                                           config['use_names'], config['name_len'],
...
def parse_args():
    ...
    # parser.add_argument('--data_path', type=str, default='/home/huangxin/code/data/dcs-data',
    #                     help='location of the data corpus')
    parser.add_argument('--data_path', type=str, default='/mnt/wanyao/huangxin/data/deep_code_search/example',
                        help='location of the data corpus')
    # parser.add_argument('--data_path', type=str, default='/mnt/wanyao/huangxin/data/dcs-data',
    #                     help='location of the data corpus')
